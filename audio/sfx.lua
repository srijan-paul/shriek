...
function sfx.load()
    ...
    sounds.tick_tock:setLooping(true)

	sounds["door_open"] =
			static_src("431117__inspectorj__door-front-opening-a.wav")
	...
	sounds["ui_select"] = static_src(
			"270401__littlerobotsoundfactory__menu-select-00.ogg")
	...
	m["lullaby"] = static_src(
			"369542__klankbeeld__musicbox-brahms-lullaby-loop.ogg")
